...
tap "archivebox/archivebox", trusted: true
tap "artginzburg/tap", trusted: true
...
tap "herald-email/herald"
tap "jakehilborn/jakehilborn", trusted: true
tap "jandedobbeleer/oh-my-posh", trusted: true
tap "lance0/tap", trusted: true
tap "lazynop/tap", trusted: true
tap "loopwork/tap", "https://github.com/mattt/homebrew-tap.git", trusted: true
tap "matthart1983/tap", trusted: true
tap "mattt/tap", "https://github.com/mattt/homebrew-tap.git", trusted: true
tap "microsoft/git", trusted: true
tap "moghtech/komodo", trusted: true
tap "nikitabobko/tap", trusted: true
tap "osx-cross/arm", trusted: true
tap "osx-cross/avr", trusted: true
tap "pebble/pebble-sdk", trusted: true
...
# Terminal email client and inbox cleanup tool
brew "herald-email/herald/herald", trusted: true
...
brew "qmk/qmk/qmk"
# Terminal-based automated file organizer inspired by Hazel
...
cask "ios-app-signer"
# Utility to control and manage the Simulator
cask "isimulator"
...
# Ebook reader
cask "readest"
# Automated installer for the Rockbox digital music player firmware
cask "rockboxutility"
...
cask "wireshark-app"
# Allows access to WWDC livestreams, videos and sessions
cask "wwdc"
...
go "cmd/go"
go "cmd/gofmt"
go "github.com/renatoworks/oh-my-reddit"
cargo "basalt-tui"
cargo "clin-rs"
cargo "darya"
cargo "paperless-cli"
